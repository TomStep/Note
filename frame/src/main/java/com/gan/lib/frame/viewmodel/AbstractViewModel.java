...
import com.gan.lib.frame.broad.OnBroadReceive;


public abstract class AbstractViewModel<T extends IView> implements OnBroadReceive{
    ...
    @NonNull
    private LocalBroadReceiver mLocalBroadReceiver;
    ...
    public void unRegisterReceiver(Context context){
        if(null == mLocalBroadReceiver)
            LocalBroadUtils.unRegisterReceiver(context,mLocalBroadReceiver);
    }
     ...
     * @param action 广播信号
     */
    public void registerBroadReceiver(Context context, String[] action){
        mLocalBroadReceiver = new LocalBroadReceiver(this);
        LocalBroadUtils.registerReceivers(context,mLocalBroadReceiver,action);
    }
